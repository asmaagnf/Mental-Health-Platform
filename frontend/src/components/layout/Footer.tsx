    ...
    <footer className="bg-slate-800 text-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-semibold text-white">MindPulse</span>
            </div>
            <p className="mt-4 text-slate-300">
              Connecting you with mental health professionals for a healthier mind and happier life.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/therapists" className="text-slate-300 hover:text-white transition-colors">Find a Therapist</Link></li>
              <li><Link to="/appointments" className="text-slate-300 hover:text-white transition-colors">Book an Appointment</Link></li>
              <li><Link to="/health" className="text-slate-300 hover:text-white transition-colors">Track Your Health</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 text-teal-400 mt-0.5 mr-3" />
                <span className="text-slate-300">123 Wellness Street<br />Mindful City, MC 10001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-slate-300">support@mindpulse.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700 text-center text-slate-400 text-sm">
          <p>&copy; {new Date().getFullYear()} MindPulse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
